...
import { hemodialysisService } from "@/data/international-services/hemodialysis";
import { internationalCarePath } from "@/data/international-patient-care";

const service = hemodialysisService;
...
export default function HemodialysisServicePage() {
  return (
