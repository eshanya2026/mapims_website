...
import { centralLaboratoryService } from "@/data/international-services/central-laboratory";
import { internationalCarePath } from "@/data/international-patient-care";

const service = centralLaboratoryService;
...
export default function CentralLaboratoryServicePage() {
  return (
