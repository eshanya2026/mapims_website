...
import { anaesthesiologyService } from "@/data/international-services/anaesthesiology";
import { internationalCarePath } from "@/data/international-patient-care";

const service = anaesthesiologyService;
...
export default function AnaesthesiologyServicePage() {
  return (
