...
import { generalSurgeryService } from "@/data/international-services/general-surgery";
import { internationalCarePath } from "@/data/international-patient-care";

const service = generalSurgeryService;
...
export default function GeneralSurgeryServicePage() {
  return (
