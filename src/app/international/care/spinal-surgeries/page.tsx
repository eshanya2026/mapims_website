...
import { spinalSurgeriesService } from "@/data/international-services/spinal-surgeries";
import { internationalCarePath } from "@/data/international-patient-care";

const service = spinalSurgeriesService;
...
export default function SpinalSurgeriesServicePage() {
  return (
