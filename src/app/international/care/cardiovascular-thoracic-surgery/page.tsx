...
import { cardiovascularThoracicService } from "@/data/international-services/cardiovascular-thoracic-surgery";
import { internationalCarePath } from "@/data/international-patient-care";

const service = cardiovascularThoracicService;
...
export default function CardiovascularThoracicSurgeryPage() {
  return (
