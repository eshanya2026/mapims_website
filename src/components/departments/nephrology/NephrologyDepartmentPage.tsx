...
import {
  ...
  whyChooseNephrology,
  nephrologyServices,
  nephrologyServicesIntro,
  nephrologyTechnology,
  nephrologySpeciality,
  nephrologySpecialityConditions,
  nephrologyMajorServices,
  nephrologyInfrastructure,
  nephrologyAchievementsNote,
  nephrologyTeamNote,
  nephrologyJourney,
  nephrologyJourneyPillars,
  nephrologyHeroImage,
  nephrologySpecialists,
...
const infrastructureIcons = [Building2, Users, Shield, Heart, Droplets] as const;
      ...
      <section className="relative flex min-h-[50vh] items-center overflow-hidden md:min-h-[55vh]">
        ...
        <div className="container relative z-20 mx-auto section-padding px-4">
          ...
          >
            ...
            <DepartmentHeroBadge>Best nephrology in India</DepartmentHeroBadge>
            <h1 className="text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl">
              <span className="text-red-500">Nephrology Department</span>
            </h1>
            <p className="mt-4 max-w-2xl text-lg leading-relaxed text-slate-300">
              World-class kidney care — from dialysis and transplant to CKD
              management and urological surgery at Melmaruvathur.
            </p>
          ...
          <div className="order-1 min-w-0 flex-1 lg:order-2">
            ...
            >
              <div className="max-w-3xl">
                ...
                <h2 className="mb-4 text-3xl font-bold text-slate-900 md:text-4xl">
                  Comprehensive <span className="text-red-600">Nephrology Care</span>
                </h2>
              ...
              <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5">
                {whyChooseNephrology.map((item, index) => (
                  <motion.article
                    key={item.title}
            ...
            >
              <div className="text-center">
                ...
                <h2 className="mb-4 text-3xl font-bold text-slate-900 md:text-4xl">
                  Kidney <span className="text-red-600">Health Services</span>
                </h2>
            ...
            >
              <div className="mb-10 text-center">
                ...
                <h2 className="mb-4 text-3xl font-bold text-slate-900 md:text-4xl">
                  Infrastructure &{" "}
                  <span className="text-red-600">Latest Technology</span>
                </h2>
              </div>
              <div className="mx-auto grid max-w-6xl grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                {nephrologyTechnology.map((item, index) => {
                  const Icon = technologyIcons[index] ?? Droplets;
                  return (
                    <motion.article
                      key={item}
                      ...
                      whileHover={{ y: -4 }}
                      className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm transition-all hover:border-red-100 hover:shadow-md"
                    >
            ...
            >
              <div className="max-w-3xl">
                ...
                <h2 className="mb-4 text-3xl font-bold text-slate-900 md:text-4xl">
                  {nephrologySpeciality.heading}
                </h2>
                <div className="space-y-4 leading-relaxed text-slate-600">
                  <p>{nephrologySpeciality.preview}</p>
                  <p>{nephrologySpeciality.full}</p>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <ul className="flex flex-wrap gap-2">
                  {nephrologySpecialityConditions.map((condition) => (
                    <li
                      key={condition}
              ...
              <div className="mt-12">
                <h3 className="mb-6 text-center text-xl font-bold text-slate-900 md:text-2xl">
                  Our <span className="text-red-600">Major Services</span>
                </h3>
                <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 sm:grid-cols-2">
                  {nephrologyMajorServices.map((service, index) => (
                    <motion.article
                      key={service.title}
                      initial={{ opacity: 0, y: 16 }}
                      whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                      <h4 className="mb-2 font-bold text-red-900">{service.title}</h4>
            ...
            >
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-red-800 via-red-700 to-red-900 px-8 py-10 md:px-12 md:py-14">
                <div className="relative max-w-3xl">
                  ...
                  <h2 className="mt-2 text-3xl font-bold text-white md:text-4xl">
                    World-Class <span className="text-red-200">Kidney Care Facilities</span>
                  </h2>
                </div>
              </div>
              ...
              <div className="relative z-10 mx-auto -mt-6 grid max-w-6xl grid-cols-1 gap-5 px-2 sm:grid-cols-2 md:-mt-8 md:gap-6 md:px-4 lg:grid-cols-3">
                {nephrologyInfrastructure.map((item, index) => {
            ...
            <div id="specialists" className="scroll-mt-28 border-b border-slate-100">
              <DepartmentSpecialistDoctors
                ...
                specialists={nephrologySpecialists}
                embedded
              />
            </div>
